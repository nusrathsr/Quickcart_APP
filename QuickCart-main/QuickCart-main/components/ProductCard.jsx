...
const ProductCard = ({ product }) => {
  ...
  const baseURL = 'https://res.cloudinary.com/dy1sluo6i/image/upload/v1234567/';
    ...
    >
      ...
      <div className="flex items-end justify-between w-full mt-1">
        ...
        <button
          ...
          className="max-sm:hidden px-4 py-1.5 text-white bg-orange-500 rounded-full text-xs hover:bg-orange-600 transition"
        >
          Add to Cart
        </button>
      </div>
